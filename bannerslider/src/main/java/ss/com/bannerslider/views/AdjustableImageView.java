...
public class AdjustableImageView extends ImageView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mAdjustViewBounds) {
            ...
            Log.d("Debug ","[MainActivity][setUpComponents] mDrawableWidth: " + mDrawableWidth + " mDrawableHeight: " + mDrawableHeight + " heightSize: " + heightSize + " widthSize: " + widthSize + " heightMode: " + heightMode);
